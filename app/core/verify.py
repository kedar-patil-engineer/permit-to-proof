...
_PARAMETERS: Tuple[ParameterSpec, ...] = (
    ...
    _p("PM", "air",
       ...
       "particulates"),
    _p("VOC", "air",
       {"ppm", "lb/hr", "lb/mmbtu", "tons/yr", "%"},
       {"ppm": (0, 5000), "lb/hr": (0, 5000), "lb/mmbtu": (0, 5),
        "tons/yr": (0, 100000), "%": (0, 100)},
       "voc", "vocs", "volatile organic compounds", "volatile organic compound"),
    _p("HAP", "air",
       {"lb/hr", "tons/yr", "%", "lb/mmbtu"},
       {"lb/hr": (0, 5000), "tons/yr": (0, 100000), "%": (0, 100),
        "lb/mmbtu": (0, 5)},
       "hap", "haps", "total hap", "total haps", "hazardous air pollutant",
